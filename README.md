...
const dhrishit: Developer = {
  name:       "Dhrishit Seal",
  role:       "Final Year B.Tech CSE (Health Informatics) @ VIT Bhopal",
  cgpa:        8.25,
  location:   "Mumbai, India 🇮🇳",
  interests:  ["Microservices", "Cloud Infrastructure", "Full-Stack Systems", "ML on Medical Imaging"],
...
<picture>
  ...
  <img alt="github contribution grid snake animation" src="https://raw.githubusercontent.com/Dhrishit04/Dhrishit04/output/github-contribution-grid-snake.svg" />
</picture>
...
- 📄 **IEEE Publication** — *A Comparative Study between Vision Transformers and CNN Models on Optical Computed Tomography Scans* · [IEEE Xplore](https://ieeexplore.ieee.org)
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/dhrishit-seal)
